...
class TestRectangleMethods(unittest.TestCase):
    ...
    def setUp(self):
        """ Method implanted  for each test """
        Base._Base__nb_objects = 0

    def test_new_rectangle(self):
        """ Represents test new rectangle """
        new = Rectangle(1, 1)
    ...
    def test_str(self):
        """ Represents test __str__ return value """
    ...
    def test_display_3(self):
        """ Represents test string printed """
    ...
    def test_dict_to_json(self):
        """ Represents test Dictionary to JSON string """
        r1 = Rectangle(2, 2)
    ...
    def test_load_from_file(self):
        """ Represents test load JSON file """
